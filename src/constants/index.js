...
Experienced in vehicle licensing supervision, project coordination, and customer care, demonstrating strong organizational and leadership skills. Currently pursuing a BSc in Software Engineering and Computer Science, with a solid foundation in Python programming and cloud computing. A CodeYourFuture trainee, also building projects with FreeCodeCamp while learning.`;
